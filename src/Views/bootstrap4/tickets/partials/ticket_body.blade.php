<div class="card mb-3">
    <div class="card-body row">
        <div class="col-md-6">
            <p><strong>{{ trans('ticketit::lang.owner') }}</strong>{{ trans('ticketit::lang.colon') }}<a href="{{ route("user-detail", ["userId"=>$ticket->user_id]) }}" target="_blank">{{ $ticket->user_id == $u->id ? $u->name : $ticket->user->name }}</a></p>
            <p>
